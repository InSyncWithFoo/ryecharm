...
private fun Row.cacheConfigDocumentationInput(block: Cell<JBCheckBox>.() -> Unit) =
    checkBox(message("configurations.ruff.cacheConfigDocumentation.label")).apply(block)
...
private fun RuffPanel.makeComponent() = panel {
    ...
    advancedSettingsGroup {
        ...
        row {
            cacheConfigDocumentationInput { bindSelected(state::cacheConfigDocumentation) }
            overrideCheckbox(state::cacheConfigDocumentation)
        }
    }
