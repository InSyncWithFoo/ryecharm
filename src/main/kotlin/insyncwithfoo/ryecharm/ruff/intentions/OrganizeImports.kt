...
import insyncwithfoo.ryecharm.importOrganizationIsApplicable
import insyncwithfoo.ryecharm.launch
import insyncwithfoo.ryecharm.message
import insyncwithfoo.ryecharm.notifyIfProcessIsUnsuccessfulOr
import insyncwithfoo.ryecharm.ruff.commands.Ruff
import insyncwithfoo.ryecharm.ruff.commands.organizeImports
import insyncwithfoo.ryecharm.ruff.commands.ruff
...
internal class OrganizeImports : ExternalIntentionAction, LowPriorityAction, DumbAware {
    ...
    override fun isAvailable(project: Project, editor: Editor?, file: PsiFile?): Boolean {
        ...
        return when {
            ...
            else -> editor != null && file?.importOrganizationIsApplicable == true
        }
    }
